  ...
  return (
    <section className="relative min-h-screen flex flex-col justify-center pt-28 overflow-hidden bg-black">
      ...
      <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center text-center space-y-8 animate-fade-in">
          <div className="inline-flex items-center px-3 py-1 rounded-full border border-scrapvorn-gray/30 bg-scrapvorn-gray/5 backdrop-blur-sm">
            <span className="text-sm font-medium text-scrapvorn-orange">Announcing Scrapvorn 1.0</span>
          </div>
          
          <h1 className="max-w-4xl font-bold leading-tight tracking-tighter">
            <span className="block text-gradient">Voracious Data Extraction</span>
            <span className="block text-white">For Modern Professionals</span>
          </h1>
          
          <p className="max-w-2xl text-xl text-scrapvorn-gray">
            Precise, powerful web scraping platform for marketers, data analysts, and businesses seeking actionable insights from web data.
          </p>
          ...
          <div className="mt-16 w-full">
            <p className="text-scrapvorn-gray mb-6">Trusted by data-driven teams worldwide</p>
          ...
          {[
            {
              ...
              description: "Extract data from any website with precision and speed."
            },
            {
              icon: Code,
              title: "Advanced Filters",
              description: "Filter and transform your data with our powerful query engine."
            },
            {
              icon: Shield,
              title: "Secure & Reliable",
              description: "Enterprise-grade security with rotating proxies and rate limiters."
            }
          ].map((feature, index) => (
            <FeatureCard 
              key={feature.title}
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center animate-pulse-subtle">
        <span className="text-scrapvorn-gray text-sm mb-2">Scroll to explore</span>
